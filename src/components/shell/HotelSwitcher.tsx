        ...
        <>
              ...
              >
                ...
                <span className="flex min-w-0 flex-1 flex-col">
                  ...
                  <span className="truncate text-[11.5px] text-faint">
                    {tHotels('roomTypesCount', { count: h.roomTypes.length })}
                  </span>
                </span>
                {h.status === 'draft' ? (
                  <Chip tone="draft" className="shrink-0 px-2 py-0 text-[10.5px]">
                    {tHotels('statusDraft')}
                  </Chip>
                ) : null}
                {h.id === hotelId ? (
          ...
          <p className="flex items-center gap-2 px-2.5 py-1.5 text-[11.5px] text-faint">
            ...
            {tHotels('roomTypesCount', {
              count: hotels.reduce((sum, h) => sum + h.roomTypes.length, 0),
            })}
          </p>
        </>
      )}
