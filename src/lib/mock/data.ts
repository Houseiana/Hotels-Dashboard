...
export const SEED_HOTELS: Hotel[] = [
    ...
    roomTypes: [
      {
        ...
        inventory: 24,
        pricePerNight: 8500,
        amenities: ['airConditioning', 'minibar', 'safe', 'balcony', 'flatScreenTv', 'bathrobes'],
      ...
      },
      {
        ...
        capacity: 4,
        beds: 3,
        bedConfig: '1xking, 2xsingle',
        bathrooms: 2,
        sizeM2: 65,
        inventory: 10,
        pricePerNight: 12900,
        amenities: ['airConditioning', 'kitchenette', 'safe', 'flatScreenTv', 'kettle'],
      ...
      },
      {
        ...
        inventory: 30,
        pricePerNight: 5500,
        amenities: ['airConditioning', 'safe', 'flatScreenTv', 'desk'],
    ...
    roomTypes: [
      {
        ...
        inventory: 12,
        pricePerNight: 1900,
        amenities: ['airConditioning', 'minibar', 'safe', 'balcony', 'seaViewWindow'],
      ...
      },
      {
        ...
        inventory: 20,
        pricePerNight: 1150,
        amenities: ['airConditioning', 'safe', 'flatScreenTv'],
        photos: [gradientToken(2)],
        refundable: false,
        breakfastIncluded: false,
        ratePlans: [
  ...
  },
  {
    ...
    amenities: ['freeWifi', 'gym', 'freeParking', 'elevator', 'laundry'],
    policies: {
      checkInFrom: '16:00',
      checkOutUntil: '11:00',
    ...
    roomTypes: [
      {
        ...
        inventory: 18,
        pricePerNight: 6300,
        amenities: ['airConditioning', 'kitchenette', 'flatScreenTv', 'desk'],
      ...
      },
      {
        ...
        inventory: 12,
        pricePerNight: 9500,
        amenities: ['airConditioning', 'kitchenette', 'desk', 'wardrobe'],
        photos: [gradientToken(2)],
